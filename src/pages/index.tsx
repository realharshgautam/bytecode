	...
	return (
		<>
			<main className='bg-dark-layer-2 min-h-screen'>
				<Topbar />
				<h1
					className='text-2xl text-center text-gray-400 dark:text-gray-200 font-medium
					uppercase mt-10 mb-5'
				>
					&ldquo; Efficiency over complexity &rdquo;
				</h1>
				<div className='relative overflow-x-auto mx-auto px-6 pb-10'>
					...
					<table className='text-sm text-left text-gray-300 dark:text-gray-200 sm:w-7/12 w-full max-w-[1200px] mx-auto'>
						{!loadingProblems && (
			    ...
			    {/* <form className = 'p-6 flex flex-col max-w-sm gap-3'>
					...
					<input type = 'text' placeholder='cagteory' name= 'cateory' />
